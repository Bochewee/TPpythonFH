# Interface graphique pour calculer l'utilisation de disque
...
class DiskUI:
    def __init__(self, root):
        root.title("Calculateur d'utilisation de disque")
    ...
    def calculate(self):
        try:
            ...
            if used > total:
                raise ValueError("L'espace utilisé dépasse l'espace total.")
